...
# data.train_batch_size = per-GPU prompt count
# effective global batch = train_batch_size * NUM_GPUS * training.group_size rollouts
accelerate launch \
    ...
    trainer.experiment_name='deepscaler-1.5b-16k-trl-4gpu' \
